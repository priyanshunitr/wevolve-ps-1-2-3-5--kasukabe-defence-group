...
export default function UploadPage() {
  ...
  const { setResumeFile, setParsedResume, setCandidateId, setError } =
    useResume();
        ...
        <div className="container mx-auto px-4 max-w-2xl">
          ...
          >
            ...
            <p className="text-muted-foreground">
              Our AI will parse your resume and extract key information for
              analysis
            </p>
          </motion.div>
                  ...
                  <div className="border border-border rounded-xl h-[500px] overflow-hidden bg-background">
                    {file.type === "application/pdf" ? (
                      ...
                      <div className="flex flex-col items-center justify-center h-full p-8 text-center bg-muted/5">
                        ...
                        <p className="text-sm text-muted-foreground mb-4">
                          {(file.size / 1024 / 1024).toFixed(2)} MB • Word
                          Document
                        </p>
                        <p className="text-sm text-muted-foreground max-w-xs bg-muted/50 p-4 rounded-lg">
                          ...
                          Click "Parse Resume" to process and view extracted
                          data.
                        </p>
                      </div>
                    )}
